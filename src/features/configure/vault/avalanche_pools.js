export const avalanchePools = [
  ...
  {
    id: 'joe-wlrs-usdc',
    name: 'WLRS - USDC 4% Withdrawal Fee🔥',
    token: 'WLRS - USDC 4% Withdrawal Fee🔥',
    tokenDescription: 'frozenwalrus.finance  4% WITHDRAWAL FEE - WLRS - USDC LP AC Auto Burn Vault 🔥',
  ...
  {
    id: 'joe-wshare-usdc',
    name: 'WSHARE - USDC 4% Withdrawal Fee🔥',
    token: 'WSHARE - USDC 4% Withdrawal Fee🔥',
