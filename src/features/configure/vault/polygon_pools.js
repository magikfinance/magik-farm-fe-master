export const polygonPools = [
  ...
  {
    id: 'spaceshipx-xshare-usdc', //make sure this matches the api lpPools.json file
    name: 'XSHARE-USDC LP', //name of Deposit token
    token: 'XSHARE-USDC LP', //same as Deposit Token
    tokenDescription: 'SpaceShipX - XSHARE-USDC LP AC Auto Fee Share Vault ', //uses descriptor,
    tokenAddress: '0x4B92F256C48B9752b3046b713AABa5086eB70d1f', //the actual lp token you're depositing
    tokenDecimals: 18,
    tokenDescriptionUrl: '#',
    earnedToken: 'MagikFarm - XSHARE - USDC LP', //this has to match the magikfarm receipt vault token
    ...
    tvl: 0,
    oracle: 'lps',
    oracleId: 'spaceshipx-xshare-usdc',
    oraclePrice: 0,
    depositsPaused: false,
    partnership: true,
    isMooStaked: true,
    ...
    stratType: 'StratLP',
    addLiquidityUrl:
      'https://polymm.finance/add/0x9f64D1aAcb129B844500119B50938c57aa9aD6E5/0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174',
    buyTokenUrl:
      'https://polymm.finance/swap?outputCurrency=0x9f64D1aAcb129B844500119B50938c57aa9aD6E5&inputCurrency=0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174',
  },
  {
