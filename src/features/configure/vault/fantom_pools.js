export const fantomPools = [
  ...
  },
  {
    ...
    token: 'RED MAGIK-FTM',
    tokenDescription: 'Magik.Finance',
    tokenAddress: '0xdA52C116fB258dC286CEbAB47bC5169597206574',
    tokenDecimals: 18,
    tokenDescriptionUrl: '#',
    earnedToken: 'MAGIKfarm REDMAGIK-FTM',
    earnedTokenAddress: '0x3D76b4F7472929195FB474d6BBEEf84dECF3B7C5',
    earnContractAddress: '0x3D76b4F7472929195FB474d6BBEEf84dECF3B7C5',
    pricePerFullShare: 1,
    tvl: 0,
    oracle: 'lps',
    oracleId: 'red-ftm-magik',
    oraclePrice: 0,
    depositsPaused: false,
    partnership: true,
    isMooStaked: true,
    ...
    stratType: 'StratLP',
    addLiquidityUrl:
      'https://app.redemption.fi/liquidity/forge/ETH/0x87a5C9B60A3aaf1064006FE64285018e50e0d020',
    buyTokenUrl: 'https://app.redemption.fi/swap',
  },
  {
    id: 'spooky-ftm-ham',
    name: 'HAM-FTM-LP',
